...
def test_E_NON_MORDE_PIU_su_una_sezione_ANNIDATA():
    """La seconda: il caso costruito che l'ha fatta scattare a torto.

    Prima di questa riparazione bastava annidare una sezione perché la guardia
    dicesse che il dettato è fuori dall'area di lavoro.
    """
